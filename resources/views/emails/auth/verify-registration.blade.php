    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#FFFFFF;border-radius:10px;overflow:hidden">
      ...
      <tr><td style="background:#0E1B29;padding:22px 36px">
        <table width="100%" cellpadding="0" cellspacing="0"><tr>
          ...
          <td align="right">
            <span style="font-size:.68rem;font-weight:600;color:#EAB308;letter-spacing:.06em;text-transform:uppercase">🔒 Código de Seguridad</span>
          </td>
        </tr></table>
      </td></tr>
      ...
      <tr><td style="padding:30px 36px 20px">
        <p style="font-size:1.2rem;font-weight:700;color:#0E1B29;line-height:1.25;margin:0 0 10px;letter-spacing:-.01em">Verifica tu cuenta</p>
        <p style="font-size:.88rem;color:#5A5465;line-height:1.8;margin:0;font-weight:400">Hola <strong style="color:#0E1B29;font-weight:600">{{ $name }}</strong>, para completar tu registro y verificar tu dirección de correo electrónico, por favor ingresa el siguiente código de seguridad en la pantalla de verificación:</p>
      </td></tr>
      ...
      <tr><td style="padding:0 36px 24px">
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#F5F1EB;border-radius:8px">
          <tr><td style="padding:16px 20px">
            <p style="font-size:.82rem;color:#5A5465;line-height:1.75;margin:0;font-weight:400">Este código <strong style="color:#0E1B29;font-weight:600">expirará en 15 minutos</strong> por motivos de seguridad. Si tú no iniciaste este registro, puedes ignorar este correo de forma segura.</p>
          </td></tr>
        </table>
      </td></tr>
