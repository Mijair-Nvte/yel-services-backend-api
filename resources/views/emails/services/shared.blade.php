...
<head>
    ...
    <title>Servicio Recomendado</title>
</head>
  ...
  <div class="em-frame">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#FFFFFF;border-radius:10px;overflow:hidden">
      ...
      <tr><td style="padding:30px 36px 20px">
        <p style="font-size:1.2rem;font-weight:700;color:#0E1B29;line-height:1.25;margin:0 0 10px;letter-spacing:-.01em">Recomendación especial para ti</p>
        <p style="font-size:.88rem;color:#5A5465;line-height:1.8;margin:0;font-weight:400">Hola, <strong style="color:#0E1B29;font-weight:600">{{ $senderName }}</strong> piensa que este servicio de YEL puede ser ideal para tus necesidades y ha decidido compartirlo contigo.</p>
      </td></tr>
      ...
      <tr><td style="padding:0 36px 24px">
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#F5F1EB;border-radius:8px">
          <tr><td style="padding:16px 20px">
            <table width="100%"><tr>
              <td style="font-size:.8rem;color:#9B93A3;width:30%;font-weight:400">Servicio</td>
              <td style="font-size:.8rem;color:#0E1B29;font-weight:600">{{ $serviceName }}</td>
            </tr></table>
          </td></tr>
        </table>
      </td></tr>
      ...
      <tr><td style="padding:0 36px 32px;text-align:center">
        <a href="{{ $serviceUrl }}" target="_blank" style="display:inline-block;background:#0E1B29;color:#FFFFFF;font-family:'Work Sans',Arial,sans-serif;font-size:.88rem;font-weight:600;padding:13px 28px;border-radius:8px;text-decoration:none">Ver Detalles del Servicio →</a>
      </td></tr>

      <tr><td style="background:#F5F1EB;padding:16px 36px;border-top:1px solid #EAE4DB">
<p style="font-size:.7rem;color:#9B93A3;margin:0;text-align:center;font-weight:400">
    YEL PRO · Recomendaciones y Servicios
</p>
      </td></tr>
